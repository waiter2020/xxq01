...
<div id="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        岗位调动 <small> 根据查询时间得到不同调岗员工信息</small>
                    </h1>
                </div>
            </div>
            <!-- /. ROW  -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="/record/g_form">
                                <div class="col-lg-6">
    ...
    <input  type="text" <c:if test="${requestScope.end!=null}">value="${requestScope.end}"</c:if> class="form-control" size="10" name="end" >
            ...
            <div class="panel-heading"  >
                <p1  style="margin-left:40%; font-size: large;">岗位调动表 </p1>
            </div>
...
<script>
    $(document).ready(function () {
        $('#dataTables-example').dataTable({"language": {
                "sProcessing": "处理中...",
